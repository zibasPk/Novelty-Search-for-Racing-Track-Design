...
def setup_logging(
    ...
    project_log = logging.getLogger("mapelite")
...
def get_logger(name: str = "") -> structlog.stdlib.BoundLogger:
    """Return a structlog logger guaranteed to be under the ``mapelite`` namespace.
