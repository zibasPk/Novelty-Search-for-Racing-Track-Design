...
def main():
    ...
    parser.add_argument("--data", type=str, default="data/datasets/metrics/dataset20k_mixedRng.npz", 
                        help="Path to input .npz dataset")
    parser.add_argument("--model", type=str, default="mapelite\\embeddings\\models\\model_metrics_VAE\\model_metrics_VAE_latent32.pth", 
                        help="Path to trained .pth model")
    parser.add_argument("--output", type=str, default="mapelite/embeddings/datasets/embeddings/track_embeddings_metrics_latent_32_rngDS.npz", 
